...
class PasswordTest {
    ...
    @ParameterizedTest
    @NullAndEmptySource
    void validatePasswordNotEmpty(String password, PasswordEncoder passwordEncoder) {
    ...
    void validatePasswordLength(String password, PasswordEncoder passwordEncoder) {
        assertThatThrownBy(() -> new Password(password, passwordEncoder))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void validatePasswordContainSpecialLetters(String password, PasswordEncoder passwordEncoder) {
        assertThatThrownBy(() -> new Password(password, passwordEncoder))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void validatePasswordContainAlphabet(String password, PasswordEncoder passwordEncoder) {
        assertThatThrownBy(() -> new Password(password, passwordEncoder))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void validatePasswordContainNumber(String password, PasswordEncoder passwordEncoder) {
        assertThatThrownBy(() -> new Password(password, passwordEncoder))
            .isInstanceOf(IllegalArgumentException.class)
